...
export const studentInfoSchema = z.object({
  ...
  name: z.string().min(6, "Name must be at least 6 characters long.").max(100, "Name must be less than 100 characters."),
  ...
  whatsappNumber: z.string()
    ...
    .regex(/^[6789]\d{9}$/, { message: "Invalid WhatsApp number. Must be a 10-digit Indian number starting with 6, 7, 8, or 9." })
